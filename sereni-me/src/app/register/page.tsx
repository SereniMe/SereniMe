    ...
    <>
      <div className="min-h-screen flex flex-row justify-center items-center joined rounded-md drop-shadow-lg">
        ...
        <div className="flex flex-row w-full h-fit justify-center items-center">
          ...
          {/* Login Form Section */}
          <div className="w-full max-w-md p-6 bg-white shadow-md text-gray-600 h-[604px]">
            <div className="mb-8 text-center">
              <h1 className="my-3 text-3xl font-bold">Create your Account</h1>
            </div>
            <form action={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  name="name"
                  id="name"
                  className="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500 dark:bg-white"
                />
              </div>
              ...
              <div className="space-y-2">
                <div>
                  <button
                    type="submit"
                    className="w-full px-8 py-3 font-semibold rounded-md bg-[#9389bd] dark:bg-[#70605b] text-white"
                  >
                    Sign up
                  </button>
                </div>
                <p className="px-6 text-sm text-center text-gray-400">
                  ...
                  <Link
                    href="/signin"
                    className="hover:underline text-[#70605b]"
                  >
                    Sign in
                  </Link>
                  .
