								...
								<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
									<div className="col-span-full sm:col-span-3">
										...
										<input
											id="name"
											type="text"
											className="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-400 dark:text-white bg-slate-100"
										/>
									</div>
									...
									<div className="col-span-full sm:col-span-2">
										...
										<input
											...
											type="text"
											placeholder=""
											className="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-white bg-slate-100"
										/>
									</div>
									<div className="col-span-full">
										...
										<div className="flex items-center mt-5">
											<input
												id="interest"
												type="checkbox"
												className="mr-2 focus:ring focus:ring-gray-400 dark:border-gray-700 dark:text-white bg-slate-100"
											/>
...
>>>>>>> d83e0414ac76eb533dde9ff93c9183287c33918a
};
